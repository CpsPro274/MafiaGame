...
export default function Home() {
  ...
  const handleScrollToBottom = (e) => {
    e?.preventDefault?.();
    const bottomEl = document.getElementById("bottom") || document.getElementById("page-bottom");
    if (bottomEl) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <main className={styles.main}>
        ...
        <section id="how-it-works" className={styles.howSection} name="how-it-works">
          <div className={styles.sectionHeader}>
